...
if __name__ == "__main__":
    ...
    print(f"🎬 MAX SPEED — BMS: {total_b} cities, {BMS_DRIVER_POOL_SIZE} drivers | District: {total_d} cities, {DISTRICT_CITY_WORKERS} workers")
    print(f"   Strategy: driver pool + eager mode + blocked resources + JS polling")
    print(f"   Both platforms running in PARALLEL\n")

    start_time = time.monotonic()

    # Run BMS and District in parallel — they use independent resources
